...
class Link_monitor extends ResourceController
{
    public $debug;
    ...
    {
        parent::__construct();
        $this->load->library('RegisteredLinkfacade');
    ...
    public function index() {
        ...
        $res = $this->registeredlinkfacade->get_all_registered_links();
    ...
    public function link_clicked() {
	    ...
	    $this->registeredlinkfacade->register_clicked_link( $hash, $email );
    ...
    public function registered_link_lookup( $hash ) {
	   ...
	   // echo "<br>id: " . $id . "<br>"; exit;
        ...
        if( strlen($hash ) == 0 ) {
            ...
            // $this->output->enable_profiler(true);
	        $res = $this->registeredlinkfacade->search( $hash );
