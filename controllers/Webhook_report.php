...
class Webhook_report extends ResourceController
{
    public $debug;
    ...
    public function index() {
        ...
        $res = $this->cwhf->get_all_reports();

        $this->output
            ->set_content_type('application/json')
            ->set_output(json_encode(["response" => ["webhook_reports" => $res]]));
    }
/*
	...
	public function add_webhook_report_form() {
    ...
    public function webhook_report_lookup( $id ) {
        ...
        if( $id == 0 ) {
            ...
            // $this->output->enable_profiler(true);
            $res = $this->cwhf->search($id);

            $this->output
                ->set_content_type('application/json')
                ->set_output(json_encode(["response" => ["webhook_report" => $res]]));
        }
        //  echo 'hi';
    }
}
